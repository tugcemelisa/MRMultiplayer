...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.Hands
{
    ...
    /// </list>
    /// </remarks>
    public class ImprovedOneEuroFilterVector3
    {
        ...
        public ImprovedOneEuroFilterVector3(Vector3 initialRawValue, float minCutoff = 0.1f, float beta = 0.02f)
        {
        ...
        /// <param name="velocity">Velocity of the pose</param>
        /// <returns>The filtered <see cref="Vector3"/> value.</returns>
        public Vector3 Filter(Vector3 rawValue, Vector3 velocity)
        {
            return Filter(rawValue, velocity, m_MinCutoff, m_Beta);
        }
        ...
        /// <returns>The filtered <see cref="Vector3"/> value.</returns>
        public Vector3 Filter(Vector3 rawValue, Vector3 velocity, float minCutoff, float beta)
        {
            ...
            Vector3 combinedCutoffs = cutoffs + Vector3.Scale(betaValues, velocity);
